...
(function () {
  ...
  !function () {
    var e = document.querySelector(".header__burger"),
        ...
        n = document.body,
        i = document.querySelector(".header__btns"),
        o = window.screen.width;
    e.addEventListener("click", function () {
      e.classList.contains("active") ? (e.classList.remove("active"), t.classList.remove("active"), n.classList.remove("lock"), o <= 600 && document.querySelector(".header__burger").insertAdjacentElement("beforeBegin", i)) : (e.classList.add("active"), t.classList.add("active"), n.classList.add("lock"), o <= 600 && document.querySelector(".menu__list").append(i));
    });
    var r = document.querySelector(".header__menu");
    Array.prototype.slice.call(r.children).forEach(function (i) {
      i.addEventListener("click", function () {
        e.classList.remove("active"), t.classList.remove("active"), n.classList.remove("lock");
      });
    });
  }(), e = "undefined" != typeof window ? window : void 0, t = function t(e, _t3) {
    var n = [],
    ...
    x.fn = x.prototype = {
      ...
      for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == _typeof(s) || h(s) || (s = {}), a === l && (s = this, a--); a < l; a++) {
        if (null != (e = arguments[a])) for (t in e) {
          i = e[t], "__proto__" !== t && s !== i && (c && i && (x.isPlainObject(i) || (o = Array.isArray(i))) ? (n = s[t], r = o && !Array.isArray(n) ? [] : o || x.isPlainObject(n) ? n : {}, o = !1, s[t] = x.extend(c, r, i)) : void 0 !== i && (s[t] = i));
        }
      }
        ...
        return i && !i[b] && (i = ke(i)), o && !o[b] && (o = ke(o, r)), ce(function (r, s, a, l) {
          ...
          if (r) {
            if (o || e) {
              ...
              for (d = y.length; d--;) {
                (u = y[d]) && -1 < (c = o ? q(r, u) : p[d]) && (r[c] = !(s[c] = u));
              }
            }
      ...
      return me.prototype = i.filters = i.pseudos, i.setFilters = new me(), s = ae.tokenize = function (e, t) {
        ...
        if (!g) {
          for (t || (t = s(e)), n = t.length; n--;) {
            (g = Se(t[n]))[b] ? u.push(g) : h.push(g);
          }

          (g = $(e, (o = h, a = 0 < (r = u).length, l = 0 < o.length, d = function d(e, t, n, s, _d) {
            var u,
                h,
                g,
                y = 0,
            ...
            for (_d && (c = t == f || t || _d); m !== C && null != (u = k[m]); m++) {
              if (l && u) {
            ...
            if (y += m, a && m !== y) {
              ...
              if (e) {
                if (0 < y) for (; m--;) {
                  w[m] || b[m] || (b[m] = L.call(s));
                }
                b = Te(b);
              }

              H.apply(s, b), _d && !e && 0 < b.length && 1 < y + r.length && ae.uniqueSort(s);
            }
    ...
    (x.fn.init = function (e, t, n) {
      ...
      if (n = n || D, "string" == typeof e) {
        ...
        if (i[1]) {
          if (t = t instanceof x ? t[0] : t, x.merge(this, x.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : g, !0)), E.test(i[1]) && x.isPlainObject(t)) for (i in t) {
        ...
        var n = [["notify", "progress", x.Callbacks("memory"), x.Callbacks("memory"), 2], ["resolve", "done", x.Callbacks("once memory"), x.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", x.Callbacks("once memory"), x.Callbacks("once memory"), 1, "rejected"]],
          ...
          then: function then(t, i, o) {
              ...
              return function () {
                var a = this,
                  ...
                  if (!(t < r)) {
                    ...
                    c = e && ("object" == _typeof(e) || "function" == typeof e) && e.then, h(c) ? o ? c.call(e, s(r, n, P, o), s(r, n, M, o)) : (r++, c.call(e, s(r, n, P, o), s(r, n, M, o), s(r, n, P, n.notifyWith))) : (i !== P && (a = void 0, l = [e]), (o || n.resolveWith)(a, l));
                  }
                },
                    d = o ? c : function () {
                  try {
            ...
            return x.Deferred(function (e) {
              n[0][3].add(s(0, e, h(o) ? o : P, e.notifyWith)), n[1][3].add(s(0, e, h(t) ? t : P)), n[2][3].add(s(0, e, h(i) ? i : M));
            }).promise();
          },
    ...
    x.fn.ready = function (e) {
      ...
      ready: function ready(e) {
        (!0 === e ? --x.readyWait : x.isReady) || (x.isReady = !0) !== e && 0 < --x.readyWait || W.resolveWith(g, [x]);
      }
    ...
    var F = function F(e, t, n, i, o, r, s) {
      var a = 0,
          l = e.length,
          c = null == n;
      if ("object" === w(n)) for (a in o = !0, n) {
        F(e, t, a, n[a], !0, r, s);
      } else if (void 0 !== i && (o = !0, h(i) || (s = !0), c && (s ? (t.call(e, i), t = null) : (c = t, t = function t(e, _t2, n) {
        return c.call(x(e), n);
      })), t)) for (; a < l; a++) {
    ...
    function X(e) {
      return e.replace(B, "ms-").replace(_, U);
    }
    ...
    V.uid = 1, V.prototype = {
      ...
      set: function set(e, t, n) {
        var i,
            o = this.cache(e);
        if ("string" == typeof t) o[X(t)] = n;else for (i in t) {
          o[X(i)] = t[i];
        }
        return o;
      },
      ...
      data: function data(e, t) {
        ...
        if (void 0 === e) {
          if (this.length && (o = Q.get(r), 1 === r.nodeType && !G.get(r, "hasDataAttrs"))) {
            for (n = s.length; n--;) {
              s[n] && 0 === (i = s[n].name).indexOf("data-") && (i = X(i.slice(5)), Z(r, i, o[i]));
            }
    ...
    function ae(e, t, n, i) {
      ...
      if (d && d[3] !== c) {
        for (l /= 2, c = c || d[3], d = +l || 1; s--;) {
          x.style(e, t, d + c), (1 - r) * (1 - (r = a() / l || .5)) <= 0 && (s = 0), d /= r;
        }
    ...
    function we(e, t, n, i, o) {
      for (var r, s, a, l, c, d, u = t.createDocumentFragment(), p = [], f = 0, h = e.length; f < h; f++) {
        if ((r = e[f]) || 0 === r) if ("object" === w(r)) x.merge(p, r.nodeType ? [r] : r);else if (me.test(r)) {
          for (s = s || u.appendChild(t.createElement("div")), a = (fe.exec(r) || ["", ""])[1].toLowerCase(), l = ve[a] || ve._default, s.innerHTML = l[1] + x.htmlPrefilter(r) + l[2], d = l[0]; d--;) {
            s = s.lastChild;
          }
      ...
      for (u.textContent = "", f = 0; r = p[f++];) {
        if (i && -1 < x.inArray(r, i)) o && o.push(r);else if (c = oe(r), s = ge(u.appendChild(r), "script"), c && ye(s), n) for (d = 0; r = s[d++];) {
    ...
    x.event = {
      ...
      add: function add(e, t, n, i, o) {
        ...
        if (Y(e)) for (n.handler && (n = (r = n).handler, o = r.selector), o && x.find.matchesSelector(ie, o), n.guid || (n.guid = x.guid++), (l = g.events) || (l = g.events = Object.create(null)), (s = g.handle) || (s = g.handle = function (t) {
          ...
          f = v = (a = be.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), f && (u = x.event.special[f] || {}, f = (o ? u.delegateType : u.bindType) || f, u = x.event.special[f] || {}, d = x.extend({
            type: f,
            origType: v,
            data: i,
            handler: n,
        ...
        if (l.delegateTarget = this, !d.preDispatch || !1 !== d.preDispatch.call(this, l)) {
          for (s = x.event.handlers.call(this, l, c), t = 0; (o = s[t++]) && !l.isPropagationStopped();) {
            for (l.currentTarget = o.elem, n = 0; (r = o.handlers[n++]) && !l.isImmediatePropagationStopped();) {
              l.rnamespace && !1 !== r.namespace && !l.rnamespace.test(r.namespace) || (l.handleObj = r, l.data = r.data, void 0 !== (i = ((x.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, a)) && !1 === (l.result = i) && (l.preventDefault(), l.stopPropagation()));
            }
          }
      ...
      handlers: function handlers(e, t) {
        ...
        if (l && c.nodeType && !("click" === e.type && 1 <= e.button)) for (; c !== this; c = c.parentNode || this) {
          if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
            for (r = [], s = {}, n = 0; n < l; n++) {
              void 0 === s[o = (i = t[n]).selector + " "] && (s[o] = i.needsContext ? -1 < x(o, this).index(c) : x.find(o, this, null, [c]).length), s[o] && r.push(i);
            }
      ...
      special: {
        ...
        click: {
          setup: function setup(e) {
            var t = this || e;
            return pe.test(t.type) && t.click && A(t, "input") && Ce(t, "click", xe), !1;
          },
    ...
    function He(e, t, n, i) {
      ...
      var o,
          ...
          g = t[0],
          y = h(g);
      if (y || 1 < p && "string" == typeof g && !f.checkClone && Ae.test(g)) return e.each(function (o) {
        var r = e.eq(o);
        y && (t[0] = g.call(this, o, r.html())), He(r, t, n, i);
      });

      if (p && (s = (o = we(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === o.childNodes.length && (o = s), s || i)) {
        for (l = (a = x.map(ge(o, "script"), De)).length; u < p; u++) {
          c = o, u !== v && (c = x.clone(c, !0, !0), l && x.merge(a, ge(c, "script"))), n.call(e[u], c, u);
        }

        if (l) for (d = a[a.length - 1].ownerDocument, x.map(a, Le), u = 0; u < l; u++) {
          c = a[u], he.test(c.type || "") && !G.access(c, "globalEval") && x.contains(d, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? x._evalUrl && !c.noModule && x._evalUrl(c.src, {
    ...
    function Oe(e, t, n) {
      for (var i, o = t ? x.filter(t, e) : e, r = 0; null != (i = o[r]); r++) {
        n || 1 !== i.nodeType || x.cleanData(ge(i)), i.parentNode && (n && oe(i) && ye(ge(i, "script")), i.parentNode.removeChild(i));
      }
    ...
    x.extend({
      ...
      clone: function clone(e, t, n) {
        var i,
            ...
            d = e.cloneNode(!0),
            u = oe(e);
        if (!(f.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || x.isXMLDoc(e))) for (s = ge(d), i = 0, o = (r = ge(e)).length; i < o; i++) {
        ...
        if (t) if (n) for (r = r || ge(e), s = s || ge(d), i = 0, o = r.length; i < o; i++) {
          Ne(r[i], s[i]);
        } else Ne(e, d);
      ...
      x.fn[e] = function (e) {
        for (var n, i = [], o = x(e), r = o.length - 1, a = 0; a <= r; a++) {
          n = a === r ? this : this.clone(!0), x(o[a])[t](n), s.apply(i, n.get());
        }
    ...
    function Fe(e, t, n) {
      var i,
          ...
          a = Pe.test(t),
          l = e.style;
      return (n = n || Me(e)) && (s = n.getPropertyValue(t) || n[t], a && (s = s.replace(Re, "$1")), "" !== s || oe(e) || (s = x.style(e, t)), !f.pixelBoxStyles() && qe.test(s) && ze.test(t) && (i = l.width, o = l.minWidth, r = l.maxWidth, l.minWidth = l.maxWidth = l.width = s, s = n.width, l.width = i, l.minWidth = o, l.maxWidth = r)), void 0 !== s ? s + "" : s;
    }
    ...
    function Ke(e, t, n, i, o, r) {
      ...
      for (; s < 4; s += 2) {
        "margin" === n && (l += x.css(e, n + ne[s], !0, o)), i ? ("content" === n && (l -= x.css(e, "padding" + ne[s], !0, o)), "margin" !== n && (l -= x.css(e, "border" + ne[s] + "Width", !0, o))) : (l += x.css(e, "padding" + ne[s], !0, o), "padding" !== n ? l += x.css(e, "border" + ne[s] + "Width", !0, o) : a += x.css(e, "border" + ne[s] + "Width", !0, o));
      }
    ...
    x.extend({
      ...
      style: function style(e, t, n, i) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          var o,
              ...
              l = Pe.test(t),
              c = e.style;
          if (l || (t = Ye(a)), s = x.cssHooks[t] || x.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (o = s.get(e, !1, i)) ? o : c[t];
          "string" == (r = _typeof(n)) && (o = te.exec(n)) && o[1] && (n = ae(e, t, o), r = "number"), null != n && n == n && ("number" !== r || l || (n += o && o[3] || (x.cssNumber[a] ? "" : "px")), f.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n));
        }
      },
      css: function css(e, t, n, i) {
        var o,
            ...
            s,
            a = X(t);
        return Pe.test(t) || (t = Ye(a)), (s = x.cssHooks[t] || x.cssHooks[a]) && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = Fe(e, t, i)), "normal" === o && t in Qe && (o = Qe[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o;
      }
    }), x.each(["height", "width"], function (e, t) {
      x.cssHooks[t] = {
        get: function get(e, n, i) {
          if (n) return !Ve.test(x.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ze(e, t, i) : Ie(e, Ge, function () {
            return Ze(e, t, i);
          });
        },
    ...
    function ut(e, t, n) {
      var i,
        ...
        for (var t = tt || lt(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), r = 0, s = c.tweens.length; r < s; r++) {
          c.tweens[r].run(i);
        }
      ...
      for (function (e, t) {
        ...
        for (n in e) {
          if (o = t[i = X(n)], r = e[n], Array.isArray(r) && (o = r[1], r = e[n] = r[0]), n !== i && (e[i] = r, delete e[n]), (s = x.cssHooks[i]) && ("expand" in s)) for (n in r = s.expand(r), delete e[i], r) {
    ...
    x.Animation = x.extend(ut, {
      ...
      prefilters: [function (e, t, n) {
        ...
        if ((l = !x.isEmptyObject(t)) || !x.isEmptyObject(f)) for (i in u && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = g && g.display) && (c = G.get(e, "display")), "none" === (d = x.css(e, "display")) && (c ? d = c : (ce([e], !0), c = e.style.display || c, d = x.css(e, "display"), ce([e]))), ("inline" === d || "inline-block" === d && null != c) && "none" === x.css(e, "float") && (l || (p.done(function () {
          ...
          l || (g ? "hidden" in g && (v = g.hidden) : g = G.access(e, "fxshow", {
            ...
            for (i in v || ce([e]), G.remove(e, "fxshow"), f) {
              x.style(e, i, f[i]);
            }
          })), l = dt(v ? g[i] : 0, i, p), i in g || (g[i] = l.start, v && (l.end = l.start, l.start = 0));
        }
      }],
      ...
      var i = e && "object" == _typeof(e) ? x.extend({}, e) : {
    ...
    }, it = g.createElement("input"), ot = g.createElement("select").appendChild(g.createElement("option")), it.type = "checkbox", f.checkOn = "" !== it.value, f.optSelected = ot.selected, (it = g.createElement("input")).value = "t", it.type = "radio", f.radioValue = "t" === it.value;
    var pt,
    ...
    x.fn.extend({
      ...
      attr: function attr(e, t, n) {
        var i,
            o,
            r = e.nodeType;
        if (3 !== r && 8 !== r && 2 !== r) return void 0 === e.getAttribute ? x.prop(e, t, n) : (1 === r && x.isXMLDoc(e) || (o = x.attrHooks[t.toLowerCase()] || (x.expr.match.bool.test(t) ? pt : void 0)), void 0 !== n ? null === n ? void x.removeAttr(e, t) : o && "set" in o && void 0 !== (i = o.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : o && "get" in o && null !== (i = o.get(e, t)) ? i : null == (i = x.find.attr(e, t)) ? void 0 : i);
      },
      attrHooks: {
        type: {
    ...
    x.fn.extend({
      ...
      toggleClass: function toggleClass(e, t) {
        ...
        }) : "boolean" == typeof t && a ? t ? this.addClass(e) : this.removeClass(e) : (n = mt(e), this.each(function () {
          if (a) for (r = x(this), o = 0; o < n.length; o++) {
            i = n[o], r.hasClass(i) ? r.removeClass(i) : r.addClass(i);
          } else void 0 !== e && "boolean" !== s || ((i = yt(this)) && G.set(this, "__className__", i), this.setAttribute && this.setAttribute("class", i || !1 === e ? "" : G.get(this, "__className__") || ""));
        }));
      },
    ...
    x.fn.extend({
      val: function val(e) {
        ...
        })) : o ? (t = x.valHooks[o.type] || x.valHooks[o.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(o, "value")) ? n : "string" == typeof (n = o.value) ? n.replace(wt, "") : null == n ? "" : n : void 0;
      }
    }), x.extend({
      valHooks: {
        option: {
    ...
    x.extend(x.event, {
      trigger: function trigger(t, n, i, o) {
        ...
        if (s = f = a = i = i || g, 3 !== i.nodeType && 8 !== i.nodeType && !bt.test(m + x.event.triggered) && (-1 < m.indexOf(".") && (m = (w = m.split(".")).shift(), w.sort()), c = m.indexOf(":") < 0 && "on" + m, (t = t[x.expando] ? t : new x.Event(m, "object" == _typeof(t) && t)).isTrigger = o ? 2 : 3, t.namespace = w.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + w.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : x.makeArray(n, [t]), p = x.event.special[m] || {}, o || !p.trigger || !1 !== p.trigger.apply(i, n))) {
          if (!o && !p.noBubble && !v(i)) {
            for (l = p.delegateType || m, bt.test(l + m) || (s = s.parentNode); s; s = s.parentNode) {
              y.push(s), a = s;
            }
          ...
          for (r = 0; (s = y[r++]) && !t.isPropagationStopped();) {
            f = s, t.type = 1 < r ? l : p.bindType || m, (u = (G.get(s, "events") || Object.create(null))[t.type] && G.get(s, "handle")) && u.apply(s, n), (u = c && s[c]) && u.apply && Y(s) && (t.result = u.apply(s, n), !1 === t.result && t.preventDefault());
          }

          return t.type = m, o || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(y.pop(), n) || !Y(i) || c && h(i[m]) && !v(i) && ((a = i[c]) && (i[c] = null), x.event.triggered = m, t.isPropagationStopped() && f.addEventListener(m, xt), i[m](), t.isPropagationStopped() && f.removeEventListener(m, xt), x.event.triggered = void 0, a && (i[c] = a)), t.result;
        }
      },
    ...
    function jt(e, t, n, i) {
      ...
      if (Array.isArray(t)) x.each(t, function (t, o) {
        n || Ct.test(e) ? i(e, o) : jt(e + "[" + ("object" == _typeof(o) && null != o ? t : "") + "]", o, n, i);
    ...
    x.param = function (e, t) {
      ...
      serializeArray: function serializeArray() {
        return this.map(function () {
          ...
          var e = this.type;
          return this.name && !x(this).is(":disabled") && Et.test(this.nodeName) && !At.test(e) && (this.checked || !pe.test(e));
        }).map(function (e, t) {
          var n = x(this).val();
    ...
    zt.href = Tt.href, x.extend({
      ...
      ajax: function ajax(t, n) {
        ...
        if (y.promise(S), f.url = ((t || f.url || Tt.href) + "").replace(qt, Tt.protocol + "//"), f.type = n.method || n.type || f.method || f.type, f.dataTypes = (f.dataType || "*").toLowerCase().match(q) || [""], null == f.crossDomain) {
          l = g.createElement("a");
        ...
        if (f.data && f.processData && "string" != typeof f.data && (f.data = x.param(f.data, f.traditional)), Rt(Pt, f, n, S), c) return S;

        for (u in (d = x.event && f.global) && 0 == x.active++ && x.event.trigger("ajaxStart"), f.type = f.type.toUpperCase(), f.hasContent = !Ot.test(f.type), o = f.url.replace(Lt, ""), f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(Dt, "+")) : (p = f.url.slice(o.length), f.data && (f.processData || "string" == typeof f.data) && (o += (St.test(o) ? "&" : "?") + f.data, delete f.data), !1 === f.cache && (o = o.replace(Nt, "$1"), p = (St.test(o) ? "&" : "?") + "_=" + kt.guid++ + p), f.url = o + p), f.ifModified && (x.lastModified[o] && S.setRequestHeader("If-Modified-Since", x.lastModified[o]), x.etag[o] && S.setRequestHeader("If-None-Match", x.etag[o])), (f.data && f.hasContent && !1 !== f.contentType || n.contentType) && S.setRequestHeader("Content-Type", f.contentType), S.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + It + "; q=0.01" : "") : f.accepts["*"]), f.headers) {
          S.setRequestHeader(u, f.headers[u]);
        }

        if (f.beforeSend && (!1 === f.beforeSend.call(h, S, f) || c)) return S.abort();

        if (k = "abort", m.add(f.complete), S.done(f.success), S.fail(f.error), i = Rt(Mt, f, n, S)) {
        ...
        function C(t, n, s, l) {
          var u,
              ...
              T,
              k = n;
          c || (c = !0, a && e.clearTimeout(a), i = void 0, r = l || "", S.readyState = 0 < t ? 4 : 0, u = 200 <= t && t < 300 || 304 === t, s && (b = function (e, t, n) {
          ...
          }(f, S, s)), !u && -1 < x.inArray("script", f.dataTypes) && x.inArray("json", f.dataTypes) < 0 && (f.converters["text script"] = function () {}), b = function (e, t, n, i) {
            var o,
                r,
                s,
                a,
    ...
    f.cors = !!_t && "withCredentials" in _t, f.ajax = _t = !!_t, x.ajaxTransport(function (t) {
      ...
      if (f.cors || _t && !t.crossDomain) return {
        send: function send(o, r) {
          ...
          _n = function n(e) {
            return function () {
              _n && (_n = i = a.onload = a.onerror = a.onabort = a.ontimeout = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? r(0, "error") : r(a.status, a.statusText) : r(Bt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                binary: a.response
              } : {
                text: a.responseText
    ...
    x.ajaxSetup({
      ...
      jsonpCallback: function jsonpCallback() {
        var e = Xt.pop() || x.expando + "_" + kt.guid++;
        return this[e] = !0, e;
      }
      ...
      if (a || "jsonp" === t.dataTypes[0]) return o = t.jsonpCallback = h(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Yt, "$1" + o) : !1 !== t.jsonp && (t.url += (St.test(t.url) ? "&" : "?") + t.jsonp + "=" + o), t.converters["script json"] = function () {
    ...
    }), f.createHTMLDocument = ((Ut = g.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Ut.childNodes.length), x.parseHTML = function (e, t, n) {
      return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (f.createHTMLDocument ? ((i = (t = g.implementation.createHTMLDocument("")).createElement("base")).href = g.location.href, t.head.appendChild(i)) : t = g), r = !n && [], (o = E.exec(e)) ? [t.createElement(o[1])] : (o = we([e], t, r), r && r.length && x(r).remove(), x.merge([], o.childNodes)));
      var i, o, r;
      ...
      var i,
          ...
          s = this,
          a = e.indexOf(" ");
      return -1 < a && (i = gt(e.slice(a)), e = e.slice(0, a)), h(t) ? (n = t, t = void 0) : t && "object" == _typeof(t) && (o = "POST"), 0 < s.length && x.ajax({
        url: e,
        type: o || "GET",
        dataType: "html",
        data: t
      ...
      x.cssHooks[t] = Be(f.pixelPosition, function (e, n) {
        if (n) return n = Fe(e, t), qe.test(n) ? x(e).position()[t] + "px" : n;
      });
    }), x.each({
      Height: "height",
      Width: "width"
    ...
    x.proxy = function (e, t) {
      var n, i, r;
      if ("string" == typeof t && (n = e[t], t = e, e = n), h(e)) return i = o.call(arguments, 2), (r = function r() {
  ...
  }, "function" == typeof define && define.amd ? define(["jquery"], n) : "undefined" != typeof exports ? module.exports = n(require("jquery")) : n(jQuery), function (e) {
    var t = new Image();
    ...
    var e = document.querySelectorAll(".ibg");

    for (var t = 0; t < e.length; t++) {
      e[t].querySelector("img") && (e[t].style.backgroundImage = "url(" + e[t].querySelector("img").getAttribute("src") + ")");
    }
  }();
  var i = window.screen.width;
  i <= 991.98 && document.querySelector(".intro").append(document.querySelector(".intro__media")), i <= 767.98 && document.querySelector(".features").append(document.querySelector(".features__media")), i <= 767.98 && document.querySelector(".plan-block__media").remove(), $(document).ready(function () {
    ...
    }), $(".menu__item").on("click", "a", function (e) {
      e.preventDefault();
